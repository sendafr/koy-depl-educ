...
function Media() {
    ...
    case 'document':
      return (
        <div className="modal-preview-document" style={{ textAlign: 'center', padding: '2rem' }}>
          ...
          <a href={file} target="_blank" rel="noopener noreferrer" className="btn btn-primary" style={{ marginTop: '1rem', display: 'inline-block' }}>
            Open Document
          </a>
        </div>
      );
  ...
  return (
    <div className="media-container">
      ...
      {/* Preview Modal for Existing Media */}
          ...
          <div className="modal-content" onClick={(e) => e.stopPropagation()}>
            ...
            <div className="modal-details">
              <div className="details-grid">
                ...
                {previewMedia.downloads_count && (
                  <div className="detail-item">
                    <strong>⬇️ Downloads:</strong>
                    <p>{previewMedia.downloads_count}</p>
                  </div>
                )}
              </div>
            </div>
